...
import { Users, Trophy, Gift, ArrowUpRight, Wallet, LogOut } from "lucide-react"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 md:px-12 py-4 sm:py-6 md:py-8">
        ...
        >
          ...
          <button 
            ...
            className="flex items-center gap-2 px-3 py-2 text-gray-300 hover:text-white transition-colors rounded-lg hover:bg-white/10 border border-transparent hover:border-white/20"
            aria-label="Sign out"
            title="Exit / Sign out"
          >
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="mt-4 sm:mt-6 md:mt-8">
          ...
          <div className={activeTab !== "airdrop" ? "hidden" : ""}>
            <AirdropSection />
          </div>
